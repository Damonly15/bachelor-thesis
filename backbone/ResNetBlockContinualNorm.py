...
from utils.continual_normalization import CN
...
class ResNetContinualNorm(MammothBackbone):
    """
    ...
    def __init__(self, block: BasicBlock, num_blocks: List[int],
        ...
        """
        super(ResNetContinualNorm, self).__init__()
        self.return_prerelu = False
        self.device = "cpu"
        self.in_planes = nf
        self.block = block
...
def resnet18continualnorm(nclasses: int, nf: int = 64) -> ResNetContinualNorm:
    """
    ...
    Returns:
        ResNet network
    """
    return ResNetContinualNorm(BasicBlock, [2, 2, 2, 2], nclasses, nf)


def resnet34continualnorm(nclasses: int, nf: int = 64) -> ResNetContinualNorm:
    """
    ...
    Returns:
        ResNet network
    """
    return ResNetContinualNorm(BasicBlock, [3, 4, 6, 3], nclasses, nf)