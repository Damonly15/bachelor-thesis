...
class IncrementalCIFAR100224(ContinualDataset):
    """
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), IncrementalCIFAR100224.TRANSFORM])
        return transform
    ...
    def get_normalization_transform():
        transform = transforms.Normalize(IncrementalCIFAR100224.MEAN, IncrementalCIFAR100224.STD)
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize(IncrementalCIFAR100224.MEAN, IncrementalCIFAR100224.STD)
        return transform
