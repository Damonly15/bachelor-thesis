...
class IncrementalCIFAR100Chunks(ContinualDataset):
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), IncrementalCIFAR100Chunks.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone(args, model_compatibility):
        return resnet18_bottleneck(nclasses = IncrementalCIFAR100Chunks.N_CLASSES, n_feats=10, cpt=-1)
    ...
    def get_normalization_transform():
        transform = transforms.Normalize(IncrementalCIFAR100Chunks.MEAN, IncrementalCIFAR100Chunks.STD)
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize(IncrementalCIFAR100Chunks.MEAN, IncrementalCIFAR100Chunks.STD)
        return transform
